  ...
  return (
    <div className='font-montserrat container mx-auto px-4'>
      <div className='flex items-center justify-center flex-col h-[20vh]  text-center'>
        <h1 className='text-4xl font-bold text-red-5'>Update exist Car</h1>
        <p className='mt-3 text-netral-7'>
          Here you can update existed car to the collection you own.
        </p>
        <p>
          we talking about the car
          <a href='#' className='font-bold text-lg px-1 mt-5 text-red-5'>
            Audi
          </a>
        </p>
      </div>
