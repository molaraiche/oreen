...
const Newsletter = () => {
  return (
    <div className='my-20 md:px-[417px] py-[50px]'>
      ...
      <div className='flex gap-3 items-center mt-7 '>
        <div className='relative w-full'>
          <input
            ...
            required
            className='pl-10 pr-4 py-2 border h-14 rounded-md w-full text-netral-9 focus:outline-none placeholder:text-netral-3'
          />
